...
class AtmMachinesControllerTest < ActionController::TestCase
  ...
  test "should create atm_machine" do
    assert_difference('AtmMachine.count') do
      post :create, atm_machine: { address: @atm_machine.address, ctiy: @atm_machine.ctiy, latitude: @atm_machine.latitude, longitude: @atm_machine.longitude, name: @atm_machine.name, street: @atm_machine.street }
    end
  ...
  test "should update atm_machine" do
    patch :update, id: @atm_machine, atm_machine: { address: @atm_machine.address, ctiy: @atm_machine.ctiy, latitude: @atm_machine.latitude, longitude: @atm_machine.longitude, name: @atm_machine.name, street: @atm_machine.street }
    assert_redirected_to atm_machine_path(assigns(:atm_machine))
  end
